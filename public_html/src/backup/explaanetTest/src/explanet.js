...
const renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true });
  ...
  function objMesh() {
   ...
   let bBox01 = new THREE.Mesh(
    ...
    let bPlane = new THREE.GridHelper(5000, 37);
  ...
  function createHexSphere(iNumSubdiv) {
    ...
    var hexoplanetGeometry = new THREE.IcosahedronGeometry(200, 0);
  ...
  var g_hexoplanetGeometry = createHexSphere(iNumSubdivisions);
   var mesh = new THREE.Mesh(g_hexoplanetGeometry, g_material11);
  mesh.position.y = 0;
  mesh.position.x = 0;
  scene.add(mesh);
